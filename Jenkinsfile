  ...
  stages {
    ...
    stage('Upload to Artifactory') {
      steps {
        ...
        nexusArtifactUploader artifacts: [[artifactId: 'RoutWebApp1.war', classifier: '', file: 'C:\Users\39601483\.jenkins\workspace\Job_Declarative_Test_01\NigamTestApp1\target\RoutWebApp1.war', type: 'bin']], credentialsId: 'nexus_admin', groupId: 'gov.ohio.jfs', nexusUrl: 'localhost:9091', nexusVersion: 'nexus3', protocol: 'http', repository: 'maven-releases', version: 'v1'
